...
<%@ page isELIgnored="false"%>
	<%--分页显示的开始 --%>
    	<div style="text-align:center">
    		...
    		<!--  <a href="/store_5/ProductServlet?method=findProductsByCidwithPage&cid=1&num=1">首页</a>-->
    		...
    		<c:forEach begin="${page.startPage}" end="${page.endPage}" var="pagenum">
    			<a href="${page.url}&num=${pagenum}">${pagenum}</a>
    		</c:forEach>
    		...
    		<script type="text/javascript">
    			function jump(){
    				...
    				//转向分页显示的Servlet
    				window.location.href="${page.url}&num="+pagenum;
    			}
    		</script>
    	</div>
    	<%--分页显示的结束--%>
