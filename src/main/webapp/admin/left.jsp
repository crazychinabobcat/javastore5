...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('010201','0102','分类管理','${pageContext.request.contextPath}/AdminServlet?method=findAllCats','','mainFrame');
		d.add('0104','01','商品管理');
		d.add('010401','0104','商品管理','${pageContext.request.contextPath}/AdminProductServlet?method=findAllProductWithPage&num=1','','mainFrame');
		d.add('010402','0104','已下架商品管理','${pageContext.request.contextPath}/AdminProductServlet?method=findAllProductXiaJia&num=1','','mainFrame');
		d.add('0105','01','订单管理');
